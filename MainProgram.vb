...
Public Class MainProgram
    ...
    Private Sub MainProgram_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Set application language to display language
        My.Application.ChangeCulture(CultureInfo.CurrentCulture.ToString)
        My.Application.ChangeUICulture(CultureInfo.CurrentUICulture.ToString)
        ...
        ElseIf CultureInfo.CurrentUICulture.ThreeLetterWindowsLanguageName = "FRA" Then
            FrancaisToolStripMenuItem.PerformClick()
        Else
            EnglishToolStripMenuItem.PerformClick()
        End If
    ...
    Private Sub LanguageToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EnglishToolStripMenuItem.Click, FrancaisToolStripMenuItem.Click
        ' Set language of program and .NET Framework
        Dim SelectedLanguage = CType(sender, ToolStripMenuItem)
        If SelectedLanguage.Text = "English" Then
            Language = "English"
        ...
        ElseIf SelectedLanguage.Text = "Français" Then
            Language = "Français"
    ...
    Private Sub FixMeNow(ByVal FixAllUsers As Boolean)
            ...
            For Each UserSid As String In UsersWithMissingProfilePictureSidList
                ...
                Else
                    ...
                    If Language = "English" Then
                        ...
                        MainProgramToolStripStatusLabel.Text = "An error occured!"
                    ElseIf Language = "Français" Then
                        MessageBox.Show("La photo de profil dans le chemin " & UserImage200PicturePath & " est introuvable sur cet ordinateur ! Veuillez essayer de changer la photo de profil pour l’utilisateur " & UserName & " et relancer la correction.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        MainProgramToolStripStatusLabel.Text = "Il y a eu une erreur !"
                    End If
                End If
            Next
        ...
        Else
            ...
            Else
                If Language = "English" Then
                    ...
                    MainProgramToolStripStatusLabel.Text = "An error occured!"
                ElseIf Language = "Français" Then
                    MessageBox.Show("La photo de profil dans le chemin " & UserImage200PicturePath & " est introuvable sur cet ordinateur ! Veuillez essayer de mettre votre photo de profil et relancez la correction.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    MainProgramToolStripStatusLabel.Text = "Il y a eu une erreur !"
                End If
            End If
        End If
        ...
        ' Ask for log off
        Dim LogOffMessage As DialogResult
        If Language = "English" Then
